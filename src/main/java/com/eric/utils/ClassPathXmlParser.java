 ...
 * @Modified By:
 */
public class ClassPathXmlParser implements Parser {
    ...
    public void parse(Map<String, Object> map, String path) {
        ...
        try {
            ...
            Parser annotationParser = new AnnotationParser();
            for (Element element: packageList){
                System.out.println(element.attributeValue("base-package"));
                annotationParser.parse(map, element.attributeValue("base-package"));
            }
